...
def main():
    ...
    if ARGS.dataset_selection == "uavid":
        ...
        loader = WHULoader()
    assert ARGS.dataset_selection in [ "uavid","inria","whu"], "Supported datasets are: uavid,inria,whu"

    # define dataset loader
    if ARGS.dataset_selection == "inria" or "whu": #inria我直接在inria_loader里面就已经把DtaLoader用过了，就不需要了
